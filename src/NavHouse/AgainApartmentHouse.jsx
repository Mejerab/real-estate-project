...
const AgainApartmentHouse = ({house}) => {
    const navigate = useNavigate();
    const { id, name, type, status, area, location, price, description, house_image } = house;
    const handleView = () => {
...
AgainApartmentHouse.propTypes = {
    house: PropTypes.object
};

export default AgainApartmentHouse;
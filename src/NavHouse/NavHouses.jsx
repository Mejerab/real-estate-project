...
const NavHouses = () => {
    return (
        <div>
            <Helmet>
                <title>Best Estates || Houses</title>
            </Helmet>
            ...
            <div className="text-center w-full">
                <h5 className="text-left ml-[108px] text-black font-bold text-lg mt-7">Types of houses</h5>
                <div role="tablist" className="tabs tabs-bordered">
                    <input type="radio" name="my_tabs_1" defaultChecked role="tab" className="tab font-bold ml-3 " aria-label="Single family" />

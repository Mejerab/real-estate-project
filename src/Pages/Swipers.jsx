        ...
        <div className="ml-2 mr-3 rounded-2xl">
                ...
                >
                    <SwiperSlide>
                        ...
                        <div className="bg-[#131313CC] text-white rounded-2xl absolute p-6 right-10 lg:bottom-[46px] bottom-32 animate__slideInLeft animate__animated">
                    ...
                    <SwiperSlide>
                        ...
                        <div className="bg-[#131313CC] text-white rounded-2xl absolute p-6 right-10 lg:bottom-12 bottom-32 animate__slideInRight animate__animated">
                            <h5 className="font-bold">Best estates</h5>
                            <p className="font-semibold">We provide the best estates in town</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        ...
                        <div className="bg-[#131313CC] text-white rounded-2xl absolute p-6 right-10 lg:bottom-12 bottom-32 animate__slideInLeft animate__animated">
                            <h5 className="font-bold">Best estates</h5>
                            <p className="font-semibold">We provide the best estates in town</p>
                        </div>
                    </SwiperSlide>
